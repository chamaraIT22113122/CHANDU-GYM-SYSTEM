    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div 
          ...
          className="lg:col-span-2 bg-[#1a1a1a] rounded-2xl border border-white/5 p-6 min-h-[400px] flex flex-col"
        >
        ...
        <motion.div 
          ...
          className="bg-[#1a1a1a] rounded-2xl border border-white/5 p-6 min-h-[400px] flex flex-col"
        >
          <h3 className="text-lg font-semibold text-white mb-6">Recent Check-ins</h3>
          <div className="flex-1 space-y-4 overflow-y-auto pr-2" style={{ scrollbarWidth: 'none' }}>
              ...
              data?.recentCheckins?.map((checkin: any) => {
                ...
                return (
                  <div key={checkin.id} className="flex items-center gap-4 border-b border-white/5 pb-4 last:border-0">
                    <div className="w-10 h-10 rounded-full bg-[#ccff00]/20 flex flex-shrink-0 items-center justify-center">
                      <span className="text-[#ccff00] font-semibold text-xs">{checkin.memberId}</span>
                    </div>
                    <div>
