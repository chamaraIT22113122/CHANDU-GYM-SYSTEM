          ...
          <div className="lg:col-span-2 glass-panel p-6">
            ...
            <div className="grid grid-cols-7 gap-2">
              {getDaysInMonth(currentMonth).map((date, i) => {
                ...
                const hasBookings = bookings.some(b => b.bookingDate === dateString && b.status === "SCHEDULED");
            ...
            {selectedDate && (
              <div className="space-y-4">
                {(() => {
                  ...
                  const dayBookings = bookings.filter(b => b.bookingDate === dateString && b.status === "SCHEDULED");
